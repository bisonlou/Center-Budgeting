...
Public Class rptBudgetVActual1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentreBudgeting.rptBudgetVActual1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBudgetVActual1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBudgetVActual1 = New rptBudgetVActual1()
        rpt.Site = Me.Site
        Return rpt
    End Function
