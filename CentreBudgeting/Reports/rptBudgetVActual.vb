...
Public Class rptBudgetVActual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CentreBudgeting.rptBudgetVActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBudgetVActual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBudgetVActual = New rptBudgetVActual()
        rpt.Site = Me.Site
        Return rpt
    End Function
